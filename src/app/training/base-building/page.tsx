...
const baseBuildingHowToJsonLd = howToJsonLd({
  name: "Base building for ultra running (12 weeks)",
  description:
  ...
  steps: [
    {
      name: "Builds Consistency",
      text: "The goal is running 4-5 days per week without injury. We start with what you can do and build from there.",
      url: `${SITE_URL}/training/base-building#focus-consistency`,
    },
    {
      name: "Grows Your Long Run",
      text: "By week 12, your long run will be 13-15 miles — enough to start our First 50K plan with confidence.",
      url: `${SITE_URL}/training/base-building#focus-long-run`,
    },
    {
      name: "Introduces Time on Feet",
      text: "Ultra running is about duration, not speed. This plan teaches you to enjoy (or at least tolerate) hours of forward motion.",
      url: `${SITE_URL}/training/base-building#focus-time-on-feet`,
    },
  ],
});
...
export default function BaseBuildingPage() {
  return (
    <>
      <Header />
      <JsonLd data={baseBuildingHowToJsonLd} />
      <main>
        ...
        <section className="py-16">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-6">
              <div id="focus-consistency" className="scroll-mt-24">
              ...
              <div id="focus-long-run" className="scroll-mt-24">
              ...
              <div id="focus-time-on-feet" className="scroll-mt-24">
